    ...
    const sampleData = [
        {
            ...
            Health_Detial: `
        ในช่วงที่โลกกำลังเผชิญกับภาวะโรคระบาดแบบนี้ ทำให้หลายคนเลือกที่จะอยู่บ้านเป็นหลัก 
        และออกไปข้างนอกเท่าที่จำเป็น เพื่อลดความเสี่ยงในการแพร่เชื้อ ซึ่งพอใช้ชีวิตอยู่แต่ในบ้านนานเข้า 
        รู้ตัวอีกทีน้ำหนักก็ขึ้น แถมร่างกายก็ไม่ฟิตเหมือนเดิมซะแล้ว<br><br>
        
        แต่ความจำเป็นที่ต้องอยู่บ้านนั้นไม่ใช่ข้ออ้างของการไม่ได้ออกกำลังกาย เพราะจริงๆ 
        แล้วยังมีรูปแบบการออกกำลังกายหลากหลายประเภทที่สามารถทำได้ในบ้าน ใช้พื้นที่น้อย 
        และไม่จำเป็นต้องจ่ายเงินเพื่อซื้ออุปกรณ์ที่มีราคาสูงเลย<br><br>
        
        มี 5 วิธีออกกำลังกายในบ้านมาแนะนำ และเมื่ออ่านบทความนี้จบแล้ว 
        เราหวังว่าคุณจะไม่มีข้ออ้างในการนั่งจมอยู่บนโซฟาทั้งวันอีกต่อไป 
        เพราะเมื่อโควิด-19 หมดไปจากโลกแล้ว เราทุกคนจะแข็งแรงไปด้วยกัน!<br><br>

        <strong>กระโดดเชือก</strong><br>
        ถือเป็นวิธีออกกำลังกายที่ง่าย และยังสามารถเผาผลาญแคลอรีได้มากอย่างไม่น่าเชื่อ 
        เพราะการกระโดดเชือกเป็นการออกกำลังกายแบบแอโรบิกที่ทำให้หัวใจเต้นเร็วขึ้น และ
        ทำการส่งเลือดไปเลี้ยงยังส่วนต่างๆ ของร่างกายได้อย่างมีประสิทธิภาพ<br><br>

        ทั้งนี้ ยังมีข้อควรคำนึงอยู่เล็กน้อย คือหากต้องการผลลัพธ์ที่ดีที่สุดก็ควรกระโดดเชือกอย่าง
        ...
        ด้มากขึ้นเช่นเดียวกัน<br><br>

        <strong>วิ่งขึ้น-ลงบันได</strong><br>
        เชื่อว่าทุกๆ บ้านน่าจะมีบันไดอยู่แล้วเป็นปกติ หรือถ้าใครอยู่คอนโดก็สามารถพลิกแพลงไปใช้
        บันไดหนีไฟก็ได้ และถ้าใครที่ยังต้องเข้าออฟฟิศก็ยิ่งเหมาะเลย เพราะแทนที่คุณจะขึ้นลงลิฟต์
        ไปมา วิธีนี้ที่จะทำให้คุณได้ออกกำลังกายในทุกๆ วัน อย่างน้อยก็ตอนเช้าและตอนเย็น<br>
        
        รู้หรือไม่ว่าการออกกำลังกายด้วยวิธีนี้สามารถเผาผลาญพลังงานได้มากกว่าที่คิด เพราะถ้าเที
        ยบกับการวิ่งบนพื้นราบธรรมดาแล้ว การวิ่งขึ้น-ลงบันไดนั้นมีความชันกว่า ทำให้มีการใช้กล้ามเ
        นื้อในส่วนอื่นๆ เพิ่มขึ้น โดยเฉพาะกล้ามเนื้อขาและน่อง<br>

        แต่ข้อควรระวังก็คือการออกกำลังกายแบบนี้ไม่เหมาะกับคนที่มีน้ำหนักตัวมาก เพราะอาจจะทำให้
        ...
        กำลังมาก สำหรับคนที่ไม่ได้ฟิตร่างกายอย่างสม่ำเสมอจึงไม่เหมาะที่จะทำทุกวัน แนะนำว่าประมาณ
         2 ครั้งต่อสัปดาห์ก็เพียงพอแล้ว<br><br>

        <strong>เล่นโยคะ</strong><br>
        วิธีนี้เหมาะกับคนที่ไม่ชอบการออกแรงหักโหมจนเกินไป เพราะโยคะจะเป็นการออกกำลังกายที่ช่วย
        เสริมสร้างความยืดหยุ่นให้กับกล้ามเนื้อ ทำให้ร่างกาย กระดูกสันหลัง และข้อต่อต่างๆ ได้ยืดเหยียด สามารถ
        ช่วยลดอาการปวดเมื่อยจากออฟฟิศซินโดรมได้ ทั้งยังช่วยให้ระบบไหลเวียนโลหิตทำงานได้ดีขึ้นอีกด้วย<br>
        สำหรับคนที่ไม่เคยเล่นโยคะมาก่อนและคิดว่าเป็นกิจกรรมที่เข้าถึงยาก บอกเลยว่าคุณอาจคิดผิด เพราะแค่มีเสื่อ
        ...
        ยังใช้พื้นที่ไม่มากอีกด้วย<br><br>

        <strong>ฮูลาฮูป</strong><br>
        เจ้าห่วงกลมๆ ที่เป็นไอเท็มยอดนิยมของสาวๆ ในการออกกำลังกายที่บ้าน เพราะ
        ...
        กระชับมากขึ้นเมื่อเล่นเป็นประจำ<br>
        ฮูลาฮูปนับว่าเป็นหนึ่งในการออกกำลังกายที่สามารถที่เผาผลาญพลังงานได้ดีทีเดียว คือ
        ...
        สูงขึ้น และยังช่วยทำให้ทักษะการทรงตัวดีขึ้นด้วย<br><br>

        <strong>แพลงกิ้ง</strong><br>
        หนึ่งในรูปแบบการออกกำลังกายที่ใช้เวลาไม่มาก แต่สามารถช่วยเสริมสร้างกล้ามเนื้อได้ดี เหมาะ
        มากสำหรับคนที่อยากฟิตหุ่น มีกล้ามหน้าท้องสวยๆ  เพราะการทำแพลงกิ้งช่วยให้สัดส่วนมีความ
        กระชับ และทำให้ร่างกายของเราสมดุลมากยิ่งขึ้น<br>
        การทำแพลงกิ้งที่ถูกต้องเริ่มจากการนอนคว่ำ แล้วใช้ข้อศอกยันพื้นในระดับความกว้างเสมอไหล่ ยก
        ตัวขึ้นบนปลายเท้าให้ขนานกับพื้นมากที่สุด ทำค้างไว้ 20 วินาที แล้วพัก 10 วินาที ทำซ้ำทั้งหมด 3 เซท<br>
        การทำแพลงกิ้งจะเป็นการเกร็งกล้ามเนื้อช่วงหน้าท้องและแผ่นหลัง ซึ่งจะทำให้กล้ามเนื้อหน้าท้องและกล้ามเนื้อด้านข้าง
        ของกระดูกสันหลังมีความแข็งแรง จึงลดความเสี่ยงที่จะเกิดอาการบาดเจ็บในบริเวณดังกล่าวได้ อีก
        ทั้งการทำแพลงกิ้งที่ถูกต้องยังช่วยลดอาการปวดหลังที่เกิดจากการนั่งนานๆ ได้อีกด้วย
    `
        },
        {
            Health_Title: "อาหารหลัก 5 หมู่มีอะไรบ้าง ที่ควรทานในแต่ละวันงกาย",
            Sub_Title: "เรามาดูกันว่าในแต่ละวันเราควรกินอะไรบ้าง",
            Health_Detial: `การรับประทานอาหารหลักให้ครบ 5 หมู่ในแต่ละวัน ที่ประกอบด้วยโปร
            ...
            เภทไหนบ้าง ในวันนี้เราจะพาไปทำความรู้จักกับอาหารหลัก 5 หมู่ มากขึ้นกันค่ะ <br><br>

            <strong>อาหารหลักหมู่ที่ 1 โปรตีน ( เนื้อสัตว์ ไข่ นม ถั่ว )</strong><br>
            โดยแหล่งอาหารที่ให้โปรตีน เช่น เนื้อหมู เนื้อไก่ เนื้อปลา นม ไข่ ถั่วเมล็ดแห้ง ถั่ว
            ...
            สร้างกล้ามเนื้อ ฟื้นฟูกล้ามเนื้อ และซ่อมแซมเนื้อเยื่อส่วนที่สึกหรอได้<br>
            โปรตีนที่เหมาะสมต่อวัน สำหรับคนทั่วไปควรได้รับโปรตีน 1 กรัม ต่อน้ำหนัก
            ตัว 1 กิโลกรัม และคนออกกำลังกาย ควรได้รับโปรตีน 2-3 กรัม ต่อน้ำหนัก
            ตัว 1 กิโลกรัม<br><br>
            
            <strong>อาหารหลักหมู่ที่ 2 คาร์โบไฮเดรต ( ข้าว แป้ง น้ำตาล เผือก มัน )</strong><br>
            โดยแหล่งอาหารที่ให้คาร์โบไฮเดรต ได้แก่ อาหารประเภทแป้ง และธัญพืชทั้งหลาย เช่น ข้าว ขนม
            ...
            ให้ร่างกายนำไปใช้ประโยชน์มากที่สุด ส่วนที่เหลือใช้จะเปลี่ยนเป็นไขมันสะสมในร่างกายได้<br>
            คาร์โบไฮเดรตที่เหมาะสมต่อวัน สำหรับคนทั่วไป ควรได้รับคาร์โบไฮเดรต 3 กรัม ต่อน้ำหนักตัว 1 กิโลกรัม 
            และคนออกกำลังกาย ควรได้รับโปรตีน 2-3 กรัม ต่อน้ำหนักตัว 1 กิโลกรัม<br><br>
            
            <strong>อาหารหลักหมู่ที่ 3 เกลือแร่ และแร่ธาตุต่าง ๆ ( พืชผัก )</strong><br>
            โดยแหล่งอาหารที่ให้เกลือแร่ และแร่ธาตุต่าง ๆ มากจาก ฟักทอง มันเทศสีเหลือง ถั่วฝักยาว ผักบุ้ง ตำ
            ...
            ช่วยปกป้องกระดูกแตกหัก และช่วยป้องกันฟันผุได้<br>
            เกลือแร่ และแร่ธาตุต่าง ๆ ที่เหมาะสมต่อวัน สำหรับผู้ใหญ่ที่แนะนำต่อวัน คือ ระหว่าง 920–2,300 มิลลิกรัม<br><br>
            
            <strong>อาหารหลักหมู่ที่ 4 วิตามิน ( ผลไม้ )</strong><br>
            โดยแหล่งอาหารที่ให้วิตามินมาจากผลไม้ชนิดต่าง ๆ เช่น กล้วย ส้ม มะละกอ แอปเปิล 
            ...
            และฟัน สุขภาพปาก ผิวหนังให้สดชื่น ช่วยให้ระบบการย่อย และการขับถ่ายเป็นปกติ<br>
            วิตามินที่เหมาะสมต่อวัน สำหรับผู้ใหญ่ที่แนะนำต่อวัน คือ ระหว่าง 60 มิลลิกรัม และสำหรับหญิง
            ตั้งครรภ์ให้นมบุตรต้องการวิตามินประมาณ 70–96 มิลลิกรัม<br><br>
            
            <strong>อาหารหลักหมู่ที่ 5 ไขมัน ( ไขมันจากพืชและสัตว์ )</strong><br>
            โดยแหล่งอาหารที่ให้ไขมัน จะแบ่งเป็นไขมันอิ่มตัวที่ส่วนใหญ่จะได้จากสัตว์ เช่น น้ำมันหมู น้ำมันไก่ น้ำมันจากวัว ครีม เนย ชีส 
            ...
            อบอุ่นแก่ร่างกาย นอกจากนี้ยังช่วยในการป้องกันการกระทบ กระเทือนของอวัยวะภายใน<br>
            ไขมันที่เหมาะสมต่อวัน สำหรับผู้ใหญ่ที่แนะนำต่อวันประมาณ 70 กรัม ซึ่งการทานไขมัน ไม่ควรรับ
            ประทานมากหรือบ่อยจนเกินไป เพราะไขมันเป็นสาเหตุสำคัญของโรคอ้วน โรคหัวใจ และหลอดเลือดได้<br><br>
            
            การทานอาหารหลักให้ครบ 5 หมู่เป็นประจำทุกวัน ที่อุดมไปด้วยโปรตีน คาร์โบไฮเดรต เกลือแร่ และแร่ธาตุต่าง ๆ วิตา
        ...
        },
        {
            ...
            Health_Detial: ` <strong>“การตื่นเช้าเป็นกำไรของชีวิต”</strong>  หลาย ๆ คนคงเคยได้ยินประโยคนี้ 
            ...
            แผลอย่างมีประสิทธิภาพ<br>
            Growth Hormone หรือ สารเคมีแห่งความเป็นหนุ่มสาว จะถูกหลั่งออกมามากที่สุดในช่วงเวลา 4 ทุ่ม – ตี 2 เราจึงเรียกช่วงเวลานี้ว่า “นาทีทองของการนอนหลับ” 
            หากได้นอนหลับอย่างมีคุณภาพในช่วงเวลาดังกล่าวจะทำให้สมองสามารถผลิตสาร Growth Hormone ได้อย่างเต็มที่ <br><br>
            
            <strong>รู้หรือไม่ว่าการนอนหลับ ช่วยชะลอวัยได้?</strong><br>
            ขณะที่เราหลับ นอกจากสมองจะผลิต Growth Hormone ออกมาแล้ว ยังมีการผลิตสารเมลาโทนิน (Melatonin) 
            ที่นอกจากจะช่วยให้เราหลับสนิทแล้ว สารนี้ยังมีบทบาทสำคัญในการป้องกันเซลล์ผิวหนังจากสารอนุมูลอิสระ ซึ่งสารเมลา
            โทนินนี้ถูกสร้างมากที่สุดในเวลากลางคืนขณะหลับสนิทและห้องมืดสนิท<br>
            ขณะเดียวกัน หากเรานอนดึก ตื่นสาย สารเซโรโตนิน (Serotonin) หรือสารที่ทำให้เรามีความสุขสดชื่นตลอดทั้งวันก็จะลดลงตาม
            ...
            ที่สุดตอนที่เราหลับเท่านั้น<br>
            ในช่วงเวลาที่เรานอนหลับ ภายในร่างกายของเราจะเปรียบเหมือนมีคนแคระมากมาย (Autonomic nervous system) ช่วย
            กันทำงานที่ซับซ้อน อย่างเช่นการควบคุมหัวใจ ความดันโลหิตให้อยู่ในระดับบที่นิ่งไม่แกว่งขึ้นลงง่ายเหมือนตอนเราตื่น หรือพูด
            ง่ายๆ ว่าการนอนหลับสามารถช่วยควบคุมความดันโลหิตได้ด้วยนั่นเอง<br>
            นอกจากนี้เมื่อหลับสนิท ตับ ไต ลำไส้ ก็จะทำงานได้ดีขึ้น สังเกตได้ว่าหากคนอดนอนอาจจะมีปัญหาท้องผูก 
            หน้าตาหม่นหมอง ไม่สดชื่น ที่สำคัญสุขภาพไม่ดี นั่นเพราะส่วนหนึ่งมาจากพิษของการนอนดึกด้วย ฉะนั้นหากนอน
            พักผ่อนอย่างเพียงพอก็เปรียบเสมือนการได้ล้างพิษไปในตัวด้วย<br><br>
            
            สรุปได้ว่า การนอนเข้านอนเร็วก่อนสี่ทุ่มและตื่นเช้า จะช่วยทำให้นาฬิกาชีวิตของเราเดินอย่างสมดุล 
            ...
            นั่นเอง รู้อย่างนี้แล้วเรามาเข้านอนก่อนสี่ทุ่มกันดีกว่านะคะ<br><br>`
        },
        {
            Health_Title: "ข้อดีของการหายใจเข้าออกลึกๆ",
            Sub_Title: "กายหายใจมีอะไรมากกว่าที่คุณคิด",
            Health_Detial: `การหายใจเข้าออกลึก ๆ หรือบางครั้งเรียกว่า การหายใจโดยใช้กะบังลม คือการหายใจเข้าลึก ๆ อย่างช้า ๆ 
            ...
            ส่งผลดีต่อสุขภาพกายและใจหลายด้านเลยทีเดียว<br><br>

            <strong>คลายความเครียด</strong><br>
            สมองคนเราจะปล่อยฮอร์โมนคอร์ติซอล เมื่อรู้สึกเครียดและกังวล เมื่อเราฝึกหายใจเข้าออกลึก ๆ 
            ...
            แม้การถอนหายใจง่าย ๆ เพียงครั้งเดียวยังช่วยลดความตึงเครียดทางร่างกาย และปรับอารมณ์ให้ดีขึ้นได้<br><br>

            <strong>ปรับการทำงานของสมองให้ดีขึ้น</strong><br>
            การศึกษาชิ้นหนึ่งได้ขอให้ผู้เข้าร่วมงานวิจัยหายใจเข้าลึก ๆ เป็นเวลา 5 วินาที และหายใจออกยาว ๆ 
